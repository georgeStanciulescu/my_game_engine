...
#ifndef MYOPENPROJECT_VERTEXINFORMATION_H
#define MYOPENPROJECT_VERTEXINFORMATION_H

#include <vector>
#include <string>
#include <glm/glm.hpp>

namespace TemporaryVertices
{
...
inline float vegetationPosition[] = {
...
#endif //MYOPENPROJECT_VERTEXINFORMATION_H